    ...
    <div className="min-h-screen flex flex-col flux-page font-sans antialiased relative overflow-hidden">
      ...
      <main className="flex-grow max-w-6xl mx-auto w-full px-6 py-12 flex flex-col">
        {!loggedInUser ? (
          ...
          <div className="flex-grow flex items-center justify-center py-10">
            <div className="w-full max-w-md flux-card shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
              <div className="p-6 md:p-8 border-b border-[var(--border)] flux-muted-surface text-center space-y-2">
                <div className="w-12 h-12 bg-[#FF3200]/10 text-[#FF3200] rounded-[14px] flex items-center justify-center mx-auto text-xl">
                  <FaKey />
                </div>
                <h2 className="text-xl font-extrabold text-[var(--text)]">Acesse seus Ingressos</h2>
                <p className="text-[var(--text-subtle)] text-xs leading-relaxed max-w-xs mx-auto">
                ...
                {step === 'email' ? (
                  <form onSubmit={handleSendOtp} className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold tracking-wide text-[var(--text-subtle)]">Endereço de E-mail</label>
                      <div className="relative">
                        <FaEnvelope className="absolute left-4 top-3.5 text-[var(--text-subtle)]" />
                        <input
                          type="email"
                          ...
                          className="flux-input w-full pl-11 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#FF3200]/15 focus:border-[#FF3200] focus:bg-[var(--input-bg)] transition-all duration-200"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-3.5 bg-[#FF3200] hover:bg-[#E62D00] text-white rounded-[14px] font-bold transition-all text-sm flex items-center justify-center gap-2 shadow-md cursor-pointer disabled:opacity-50"
                    >
                  ...
                  <form onSubmit={handleVerifyOtp} className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold tracking-wide text-[var(--text-subtle)]">Código de 6 dígitos</label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="flux-input w-full pl-11 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#FF3200]/15 focus:border-[#FF3200] focus:bg-[var(--input-bg)] transition-all duration-200 text-center tracking-widest font-mono text-lg font-bold"
                        />
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full py-3.5 bg-[#2E7D32] hover:bg-[#1b5e20] text-white rounded-[14px] font-bold transition-all text-sm flex items-center justify-center gap-2 shadow-md cursor-pointer disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="w-full text-center text-xs font-semibold text-[var(--text-subtle)] hover:text-[#FF3200] mt-2 block border-none bg-transparent cursor-pointer"
                    >
                      Alterar E-mail
                    </button>
                  </form>
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            {/* User Header Block */}
            <div className="flux-card p-6 md:p-8 rounded-[20px] shadow-xl flex flex-col justify-between items-start gap-4 relative overflow-hidden animate-in fade-in duration-300">
              <div className="space-y-1 relative z-10">
                <span className="text-[10px] font-bold tracking-wide text-[#FF3200]">Sua Carteira Digital</span>
                <h2 className="text-xl md:text-2xl font-black leading-tight">Olá, {loggedInUser.name.split('@')[0]}!</h2>
                <p className="text-[var(--text-muted)] text-xs md:text-sm font-light">
              ...
              <div className="relative w-full max-w-lg mt-2 z-10">
                <input
                  ...
                  className="w-full bg-[var(--input-bg)] focus:bg-[var(--input-bg)] text-[var(--text)] focus:text-[var(--text)] placeholder-[var(--text-subtle)] border border-[var(--border-strong)] rounded-[14px] pl-4 pr-10 py-2.5 text-xs outline-none focus:ring-2 focus:ring-[#FF3200]/15 focus:border-[#FF3200] transition-all duration-200"
                />
                <svg className={`w-4 h-4 absolute right-3 top-3.5 transition-colors ${searchFocused ? 'text-[var(--text-subtle)]' : 'text-[var(--text-subtle)]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="space-y-4 pt-2">
              <h3 className="text-base font-black text-[var(--text)] flex items-center gap-2">
                <span className="w-1 h-4 bg-[#FF3200] rounded-full inline-block" />
                Meus Ingressos
              </h3>
              ...
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="flex-grow space-y-6 w-full">
                  {loadingTickets ? (
                    <div className="flex flex-col items-center justify-center py-20 space-y-3 flux-card">
                      <FaSpinner className="w-8 h-8 animate-spin text-[#FF3200]" />
                      <p className="text-sm font-semibold text-[var(--text-subtle)]">Carregando seus ingressos...</p>
                    </div>
                  ) : filteredTickets.length === 0 ? (
                    <div className="text-center py-16 px-6 flux-card space-y-5 flex flex-col items-center justify-center shadow-sm animate-in fade-in duration-300">
                      <div className="w-12 h-12 bg-[var(--surface-muted)] rounded-full flex items-center justify-center text-[var(--text-subtle)]">
                      ...
                      <div className="space-y-1.5 text-center">
                        ...
                        <p className="text-[var(--text-subtle)] text-xs max-w-sm mx-auto">
                            ...
                            <div className="p-6 space-y-4">
                              ...
                              <div className="flex justify-between items-start gap-4">
                                <div className="space-y-1">
                                  ...
                                  <h4 className="font-extrabold text-sm text-[var(--text)] leading-snug">
                                    {ticket.batch.event.title}
                                  </h4>
                                  {ticket.holderName && (
                                    <div className="text-[10px] text-[var(--text-subtle)] font-semibold mt-1">
                                      Titular: <span className="font-bold text-[var(--text-muted)]">{ticket.holderName}</span>
                                    </div>
                                  )}
                                </div>

                                {ticket.meiaEntrada && (
                                  <span className="flux-muted-surface border px-2 py-0.5 rounded text-[9px] font-black tracking-wide">
                                    Meia
                                  </span>
                                )}
                              </div>
                              ...
                              <div className="space-y-2 border-t border-[var(--border)] pt-3">
                                <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                                  <FaCalendarDays className="w-3.5 h-3.5 text-[var(--text-subtle)] shrink-0" />
                                  <span>{eventDate}</span>
                                </div>
                                <div className="flex items-center gap-2 text-xs text-[var(--text-muted)]">
                                  <FaLocationDot className="w-3.5 h-3.5 text-[var(--text-subtle)] shrink-0" />
                                ...
                                <>
                                  ...
                                  {!ticket.isTransferred && (
                                    <button
                                      ...
                                      className="w-full py-2.5 flux-secondary-button rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                                    >
                                ...
                                <>
                                  <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <button
                                      ...
                                      className="flux-secondary-button px-3 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                                    >
                                  ...
                                  <button
                                    ...
                                    className="w-full py-2 bg-[#FF3200] hover:bg-[#E62D00] text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-sm"
                                  >
      ...
      {selectedQrTicket && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="flux-card shadow-2xl p-6 w-full max-w-sm relative animate-in fade-in zoom-in-95 duration-200">
            <button
              onClick={() => setSelectedQrTicket(null)}
              className="absolute top-4 right-4 bg-white/5 hover:bg-white/10 p-1.5 rounded-full cursor-pointer text-[var(--text-subtle)] transition-all duration-200 z-10 border-none"
            >
            ...
            <div className="text-center space-y-5 py-4">
              <div className="space-y-1">
                <h3 className="font-extrabold text-[var(--text)] text-lg leading-tight">
                  {selectedQrTicket.batch.event.title}
                </h3>
                <p className="text-[var(--text-subtle)] text-xs font-bold tracking-wide">
                  Setor: {selectedQrTicket.batch.name}
                </p>
              </div>

              {/* Dynamic QR Code based on HMAC signature link */}
              <div className="bg-white p-4 rounded-[14px] w-48 h-48 mx-auto flex items-center justify-center">
                <img
              ...
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-[var(--text-subtle)] leading-relaxed max-w-[240px] mx-auto">
      ...
      {selectedTransferTicket && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="flux-card shadow-2xl p-6 w-full max-w-md relative animate-in fade-in zoom-in-95 duration-200">
            <button
              onClick={() => {
                setSelectedTransferTicket(null);
                setTransferName('');
            ...
            <form onSubmit={handleTransferSubmit} className="space-y-5 py-2">
              ...
              {transferSuccess ? (
                ...
                <>
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold tracking-wide text-[var(--text-subtle)]">Nome do Novo Titular</label>
                    <input
                      type="text"
                      required
                      value={transferName}
                      ...
                      className="flux-input w-full px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#FF3200]/15 focus:border-[#FF3200] focus:bg-[var(--input-bg)] transition-all duration-200"
                    />
                  </div>

                  <div className="space-y-1.5">
                    <label className="text-xs font-bold tracking-wide text-[var(--text-subtle)]">CPF do Novo Titular</label>
                    <input
                      type="text"
                      required
                      value={transferCpf}
                      ...
                      maxLength={11}
                      className="flux-input w-full px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-[#FF3200]/15 focus:border-[#FF3200] focus:bg-[var(--input-bg)] transition-all duration-200 font-mono"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-[#FF3200] hover:bg-[#E62D00] text-white rounded-[14px] font-bold transition-all text-sm flex items-center justify-center gap-2 shadow-md cursor-pointer disabled:opacity-50 border-none"
                  >
