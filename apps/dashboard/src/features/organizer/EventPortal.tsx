...
function TicketsTab({ overview }: { overview: OrganizerEventOverview }) {
  return <Card className="rounded-lg bg-white"><CardHeader><CardTitle>Tickets</CardTitle></CardHeader><CardContent className="space-y-2 text-sm"><p>Minimal ticket setup: {overview.ticketSummary.ticketTypeCount ? 'Configured' : 'Not configured'}</p><p>Full Ticket Workspace is scheduled for Phase 5.</p></CardContent></Card>;
}
